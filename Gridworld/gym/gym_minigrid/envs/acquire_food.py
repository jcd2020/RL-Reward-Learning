...
class AcquireFoodEnv(MiniGridEnv):
    """
...
class FetchEnv5x5N2(AcquireFoodEnv):
    def __init__(self):
        super().__init__(size=5, numObjs=2)

class FetchEnv6x6N2(AcquireFoodEnv):
    def __init__(self):
...
register(
    id='AcquireFood-8x8-N3-v0',
    entry_point='gym_minigrid.envs:AcquireFood'
)
